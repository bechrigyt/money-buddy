...
export function ProjectList({ groups, onAdd, onDelete, onSelect }: Props) {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 bg-[#185FA5] text-white px-3 py-2 rounded-xl text-sm font-semibold"
        >
        ...
        <div className="space-y-2">
          {groups.map(group => {
            ...
            return (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-[#185FA5]/10 flex items-center justify-center flex-shrink-0">
